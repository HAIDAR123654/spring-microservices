package com.haidar.departmentservice.controller;
...
public class DepartmentController {
    ...
    @Operation(
            ...
            description = "Save Department Rest APIs is used" +
                    "to save department object in a database"
    )
    @ApiResponse(
            responseCode = "201",
    ...
    @Operation(
            ...
            description = "Get Department Rest APIs is used" +
                    "to get department object from the database"
    )
    @ApiResponse(
            responseCode = "200",
